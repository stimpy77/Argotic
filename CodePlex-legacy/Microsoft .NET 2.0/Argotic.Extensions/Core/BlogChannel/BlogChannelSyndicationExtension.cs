...
*****************************************************************************
01/23/2008	brian.kuhn	Created BlogChannelSyndicationExtension Class
****************************************************************************/
using System;
using System.IO;
using System.Xml;
...
namespace Argotic.Extensions.Core
{
    ...
    /// <remarks>
    ///     <para>
    ///         The <see cref="BlogChannelSyndicationExtension"/> extends syndicated content to specify information common to weblogs. This syndication extension conforms to the 
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Extensions\Core\BlogChannelSyndicationExtensionExample.cs" 
    ...
    public class BlogChannelSyndicationExtension : SyndicationExtension, IComparable
    {
        ...
        /// </summary>
        /// <param name="source">The <b>IXPathNavigable</b> used to load this <see cref="BlogChannelSyndicationExtension"/>.</param>
        /// <returns><b>true</b> if the <see cref="BlogChannelSyndicationExtension"/> was able to be initialized using the supplied <paramref name="source"/>; otherwise <b>false</b>.</returns>
        ...
        /// </summary>
        /// <param name="reader">The <b>XmlReader</b> used to load this <see cref="BlogChannelSyndicationExtension"/>.</param>
        /// <returns><b>true</b> if the <see cref="BlogChannelSyndicationExtension"/> was able to be initialized using the supplied <paramref name="reader"/>; otherwise <b>false</b>.</returns>
        ...
        public int CompareTo(object obj)
        {
            ...
            //------------------------------------------------------------
            BlogChannelSyndicationExtension value  = obj as BlogChannelSyndicationExtension;
            ...
            if (value != null)
            {
                ...
                result      = result | Uri.Compare(this.Context.Blink, value.Context.Blink, UriComponents.AbsoluteUri, UriFormat.Unescaped, StringComparison.OrdinalIgnoreCase);
                result      = result | Uri.Compare(this.Context.BlogRoll, value.Context.BlogRoll, UriComponents.AbsoluteUri, UriFormat.Unescaped, StringComparison.OrdinalIgnoreCase);
                result      = result | Uri.Compare(this.Context.Changes, value.Context.Changes, UriComponents.AbsoluteUri, UriFormat.Unescaped, StringComparison.OrdinalIgnoreCase);
                result      = result | Uri.Compare(this.Context.MySubscriptions, value.Context.MySubscriptions, UriComponents.AbsoluteUri, UriFormat.Unescaped, StringComparison.OrdinalIgnoreCase);
        ...
        public override bool Equals(Object obj)
        {
            ...
            //------------------------------------------------------------
            if (!(obj is BlogChannelSyndicationExtension))
            {
                return false;
            }
