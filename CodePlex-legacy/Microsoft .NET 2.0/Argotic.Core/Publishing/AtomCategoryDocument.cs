...
namespace Argotic.Publishing
{
    ...
    public class AtomCategoryDocument : ISyndicationResource, IExtensibleSyndicationObject, IAtomCommonObjectAttributes, IComparable
    {
        ...
        #region AtomCategoryDocument(Collection<AtomCategory> categories)
        /// <summary>
        ...
        #region AtomCategoryDocument(Uri href)
        /// <summary>
        ...
        #region AtomCategoryDocument(bool isFixed, Uri scheme)
        /// <summary>
        ...
        //	STATIC METHODS
        //============================================================
        #region CompareSequence(Collection<AtomCategoryDocument> source, Collection<AtomCategoryDocument> target)
        /// <summary>
        ...
        //	COLLECTION METHODS
        //============================================================
        #region AddCategory(AtomCategory category)
        /// <summary>
        ...
        #region FindCategory(Predicate<AtomCategory> match)
        /// <summary>
        ...
        #region RemoveCategory(AtomCategory category)
        /// <summary>
