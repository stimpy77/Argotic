...
*****************************************************************************
01/08/2008	brian.kuhn	Created ApmlConcept Class
****************************************************************************/
using System;
...
namespace Argotic.Syndication.Specialized
{
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\Apml\ApmlConceptExample.cs" 
    ///             region="ApmlConcept" 
    ///         />
    ///     </code>
    /// </example>
    ...
    public class ApmlConcept : IComparable, IExtensibleSyndicationObject
    {
        ...
        #region ApmlConcept(string key, decimal value)
        /// <summary>
        ...
        #region ApmlConcept(string key, decimal value, string from, DateTime utcUpdatedOn)
        /// <summary>
        /// Initializes a new instance of the <see cref="ApmlConcept"/> class using the supplied parameters.
        /// </summary>
        /// <param name="key">The unique key for this concept.</param>
