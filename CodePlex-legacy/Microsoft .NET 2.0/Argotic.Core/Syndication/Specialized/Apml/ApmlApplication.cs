...
*****************************************************************************
01/08/2008	brian.kuhn	Created ApmlApplication Class
****************************************************************************/
using System;
...
namespace Argotic.Syndication.Specialized
{
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\Apml\ApmlApplicationExample.cs" 
    ...
    public class ApmlApplication : IComparable, IExtensibleSyndicationObject
    {
        ...
        #region ApmlApplication(string name)
        /// <summary>
