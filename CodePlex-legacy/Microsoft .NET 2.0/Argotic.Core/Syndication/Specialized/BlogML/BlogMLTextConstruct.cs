...
*****************************************************************************
01/11/2008	brian.kuhn	Created BlogMLTextConstruct Class
****************************************************************************/
using System;
...
namespace Argotic.Syndication.Specialized
{
    ...
    public class BlogMLTextConstruct : IComparable, IExtensibleSyndicationObject
    {
        ...
        #region BlogMLTextConstruct(string content)
        /// <summary>
        ...
        #region BlogMLTextConstruct(string content, BlogMLContentType encoding)
        /// <summary>
        ...
        ///         <code 
        ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\BlogML\BlogMLTextConstructExample.cs" 
        ///             region="ConstructTypeAsString(BlogMLContentType type)" 
        ///         />
        ///     </code>
        /// </example>
