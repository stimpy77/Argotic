...
namespace Argotic.Syndication
{
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\GenericSyndicationFeedExample.cs" 
    ...
    public class GenericSyndicationFeed
    {
        ...
        //	COMPARISON METHODS
        //============================================================
        #region CompareSequence(Collection<GenericSyndicationCategory> source, Collection<GenericSyndicationCategory> target)
        /// <summary>
        ...
        #region Parse(OpmlDocument opmlDoc)
        /// <summary>
