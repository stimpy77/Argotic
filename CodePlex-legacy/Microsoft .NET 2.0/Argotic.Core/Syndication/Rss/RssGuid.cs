...
*****************************************************************************
12/12/2007	brian.kuhn	Created RssGuid Class
****************************************************************************/
using System;
...
namespace Argotic.Syndication
{
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\Rss\RssGuidExample.cs" 
    ///             region="RssGuid" 
    ///         />
    ///     </code>
    /// </example>
    ...
    public class RssGuid : IComparable, IExtensibleSyndicationObject
    {
        ...
        #region RssGuid(string value, bool isPermanentUrl)
        /// <summary>
        /// Initializes a new instance of the <see cref="RssGuid"/> class using the supplied value.
        /// </summary>
        /// <param name="value">A string value that uniquely identifies the item.</param>
