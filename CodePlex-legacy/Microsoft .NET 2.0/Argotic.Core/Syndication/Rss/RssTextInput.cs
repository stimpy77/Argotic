...
*****************************************************************************
12/11/2007	brian.kuhn	Created RssTextInput Class
****************************************************************************/
using System;
...
namespace Argotic.Syndication
{
    ...
    ///         <code 
    ///             source="..\..\Documentation\Microsoft .NET 2.0\CodeExamplesLibrary\Core\Rss\RssTextInputExample.cs" 
    ///             region="RssTextInput" 
    ///         />
    ///     </code>
    /// </example>
    ...
    public class RssTextInput : IComparable, IExtensibleSyndicationObject
    {
        ...
        #region RssTextInput(string description, Uri link, string name, string title)
        /// <summary>
